...
**Architecture:** D-007D4 é predominantemente documental e verificatório. Parte do checkpoint homologado D-007D3 e consolida os artefatos D-007A/B/C/D1/D2/D3; código somente pode mudar se uma lacuna real for primeiro demonstrada por teste RED e mantida dentro do escopo de fechamento.
...
- Evidência usa somente SHAs/contagens/resultados reais.
...
- [ ] Relacionar procedure de Jornada à permissão server-side e teste.
- [ ] Confirmar ausência de grants automáticos.
- [ ] Inventariar migrations reais da Jornada, dependências, objetos afetados, pré/pós-condições e recuperação.
- [ ] Inventário desatualizado exige teste RED antes de qualquer correção; sem lacuna, não alterar código.
- [ ] Commit/checkpoint `checkpoint/d007d4-task2-contracts-rbac-migrations-20260905`.
...
- [ ] Documentar ordem exata das migrations e validações intermediárias.
...
- [ ] Commit/checkpoint `checkpoint/d007d4-task3-runbook-20260905`.
...
- [ ] Confirmar regressões D-007A/B/C/D1/D2/D3, elegibilidade antes de GIS/OSRM e isolamento organização/unidade.
- [ ] Confirmar no mesmo SHA: Qualidade, GIS visual, NEO external e NEO workspace visual.
- [ ] Gate vermelho mantém `EM HOMOLOGAÇÃO`; corrigir só causa demonstrada e exigir RED para código.
- [ ] Registrar contagens reais após execução fresca.

### Task 5 — Encerramento
- [ ] Self-review sem placeholders, números presumidos ou SHAs não verificados.
...
- [ ] Commit final `docs: close journey release 1 technical scope`.
- [ ] Verificar que commit final não alterou código/migration inesperadamente; repetir gates se necessário.
