...
--> statement-breakpoint
ALTER TABLE `work_shift_pending_history` ADD CONSTRAINT `work_shift_pending_history_item_fk` FOREIGN KEY (`pending_item_id`) REFERENCES `work_shift_pending_items`(`id`) ON DELETE restrict ON UPDATE no action;
--> statement-breakpoint
