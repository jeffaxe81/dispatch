...
ALTER TABLE `work_shift_schedules` ADD CONSTRAINT `work_shift_schedules_org_unit_fk` FOREIGN KEY (`organizational_unit_id`) REFERENCES `organizational_units`(`id`) ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `work_shift_schedule_exceptions` ADD CONSTRAINT `work_shift_exceptions_assignment_fk` FOREIGN KEY (`assignment_id`) REFERENCES `work_shift_assignments`(`id`) ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `work_shift_sessions` ADD CONSTRAINT `work_shift_sessions_assignment_fk` FOREIGN KEY (`schedule_assignment_id`) REFERENCES `work_shift_assignments`(`id`) ON DELETE set null ON UPDATE no action;--> statement-breakpoint
